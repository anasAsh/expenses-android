...
- **Data deletion:** User can **clear app data** / uninstall. **Local database export** is a user-initiated file write (SAF). **Optional “daily backup”** writes a copy of the SQLite DB into a **folder the user selects** on-device; still no upload to the developer.
